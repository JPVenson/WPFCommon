...
namespace JPB.WPFToolsAwesome.Error.Resources.Templates
{
	public static class TemplateStyle
	{
		static TemplateStyle()
		{
			...
			DefaultResources.Source = new Uri($"/{name};component/Error/Resources/Templates/DefaultErrorResources.xaml",
